...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Hover effects for movie titles
    ...
    // Photo/Video buttons hover effect
    document.querySelectorAll('.image-buttons button').forEach(button => {
    ...
    if (ratingBox) {
        ratingBox.addEventListener('mouseenter', () => {
            ratingBox.style.transform = 'scale(1.05)';
